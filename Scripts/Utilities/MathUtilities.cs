...
namespace Tanks.Utilities
{
  ...
  {
    public static Vector3 CatmullRom(Vector3 previous, Vector3 start, Vector3 end, Vector3 next, float normalizedProgress)
    {
      // r = 0.5
    ...
    public static Vector3 CatmullRomDerivative(Vector3 previous, Vector3 start, Vector3 end, Vector3 next, float normalizedProgress)
    {
      float progressSquared = normalizedProgress * normalizedProgress;
